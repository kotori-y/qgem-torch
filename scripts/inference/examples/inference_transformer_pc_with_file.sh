...
ENDPOINT_STATUS_FILE="./configs/tox_pc_mtl/physchem_status.json"
...
NAME=$1
SMILES_FILE="./data/inference/TEST/physchem/smi/${NAME}.smi"

OUT_ROOT="./data/inference/TEST/physchem/pred"
if [ ! -d $OUT_ROOT ]; then
  mkdir -p $OUT_ROOT
fi

OUT_FILE="${OUT_ROOT}/${NAME}_pred.csv"
