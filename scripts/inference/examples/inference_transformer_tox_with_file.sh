...
ENDPOINT_STATUS_FILE="./configs/tox_pc_mtl/toxicity_status.json"
...
NAME=$1
SMILES_FILE="./data/inference/TEST/toxicity/smi/${NAME}.smi"

OUT_ROOT="./data/inference/TEST/toxicity/pred"
if [ ! -d $OUT_ROOT ]; then
  mkdir -p $OUT_ROOT
fi
